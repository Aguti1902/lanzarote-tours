    ...
    <>
      ...
      <section className="bg-sky-soft py-14">
        <div className="mx-auto max-w-6xl px-4 md:px-6">
          ...
          <div className="mt-12 overflow-hidden rounded-2xl bg-gradient-to-br from-[#2f3a4f] to-ocean text-white shadow-[0_20px_50px_rgba(42,122,74,0.2)] md:grid md:grid-cols-2">
